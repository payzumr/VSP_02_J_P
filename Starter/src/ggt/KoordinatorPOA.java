  ...
  // Methods for the Starter
       case 2:  // ggt/Koordinator/activateStarter
       {
         try {
           ...
           out = $rh.createReply();
         } catch (ggt.KoordinatorPackage.EAlreadyExists $ex) {
           out = $rh.createExceptionReply ();
           ggt.KoordinatorPackage.EAlreadyExistsHelper.write (out, $ex);
         }
         break;
       }
  ...
  // Methods for the Client
       case 5:  // ggt/Koordinator/startCalculation
       {
         try {
           ...
           this.startCalculation (minProcesses, maxProcesses, minDelay, maxDelay, timeout, startGGT);
           out = $rh.createReply();
         } catch (ggt.KoordinatorPackage.EInvalidAmount $ex) {
           out = $rh.createExceptionReply ();
           ggt.KoordinatorPackage.EInvalidAmountHelper.write (out, $ex);
         }
         break;
       }
       ...
       case 6:  // ggt/Koordinator/getStarterListe
       {
         ...
         } catch (ggt.KoordinatorPackage.EStarterNoSuchElement $ex) {
           out = $rh.createExceptionReply ();
           ggt.KoordinatorPackage.EStarterNoSuchElementHelper.write (out, $ex);
         }
         break;
       }
